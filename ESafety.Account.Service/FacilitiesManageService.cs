...
{
    public class FacilitiesManageService :ServiceBase, IFacilitiesManageServcie
    {
        ...
        public FacilitiesManageService(IUnitwork work)
        {
            _work = work;
            Unitwork = work;
        ...
        public ActionResult<Pager<FacilityView>> GetFacilities(PagerQuery<FacilitiesQuery> para)
        {
            try
            {
                var dbfacilities = _rpsfacilities.Queryable(p=>p.SortID==para.Query.ID);
